...
namespace EpSqlGen
{
    ...
    public class EpSqlGenerator
    {
        ...
        public static void WriteHelp()         
        {
            ...
            Console.WriteLine(appName + " MySqlQuery.sql -oMyOutputFileName -a:MyArgument1:Argument1Type:Argumet1value -a:MyArgument2:Argument2Type:Argumet2value");
            Console.WriteLine("");
            Console.WriteLine("Usage(json definition file for complex output):");
            Console.WriteLine(appName + " MyJsonDefinition.json -oMyOutputFileName -aMyArgument1:Argument1Type:Argumet1value -aMyArgument2:Argument2Type:Argumet2value");
            Console.WriteLine("");
            Console.WriteLine("Supported arguments types:  string || char || varchar2 || varchar || date || integer || decimal || number || array ");
            Console.WriteLine("");
            Console.WriteLine("");
            Console.WriteLine("Sample-sql  src:");
            Console.WriteLine( appName + " MySqlQuerry.sql -oMyOutputfile  -dt -a:Stavy:array:'P9','K9','O9' -a:Ids:array:31,32,3 -a:Produkt:string:UO -a:Od:date:4.2.2015 -a:Zmluva:number:505115 ");
            Console.WriteLine("");
            Console.WriteLine("Sample-json src:");
            Console.WriteLine( appName + " Test.json -oMyOutputfile -do -a:Stavy:array:'P9','K9','O9' -a:Ids:array:31,32,3 -a:Produkt:string:UO -a:Od:date:4.2.2015 -a:Zmluva:number:505115 ");
            Console.WriteLine("");
            Console.WriteLine("Sample-sql to json:");
            Console.WriteLine(appName + " MySqlQuerry.sql -oMyOutputfile -j -a:Stavy:array:'P9','K9','O9' -a:Ids:array:31,32,3 -a:Produkt:string:UO -a:Od:date:4.2.2015 -a:Zmluva:number:505115 ");
        }
        ...
        public void SetupEnviroment()
        {
            ...
            else
            {
                ...
                outDef = new ExcelDef { fileName = def.fileName, template = def.template, autofilter = def.autofilter, timestamp = def.timestamp, version = def.version, tabs = new List<Tab>() };
